      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a href="#" className="text-gray-600 hover:text-accent-cyan transition-colors"><Code2 size={16} /></a>
              <a href="#" className="text-gray-600 hover:text-accent-cyan transition-colors"><Globe size={16} /></a>
            </div>
          </div>
          ...
          {Object.entries(links).map(([category, items]) => (
            <div key={category}>
              ...
              <ul className="space-y-2.5">
                {items.map((item) => (
                  <li key={item}>
                    <a href="#" className="text-sm text-gray-600 hover:text-accent-cyan transition-colors">{item}</a>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div className="border-t border-white/[0.03] pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-gray-700 flex items-center gap-1">
            Made with <Heart size={10} className="text-accent-rose" /> by GyneCold Research Team
          </p>
        </div>
      </div>
    </footer>
